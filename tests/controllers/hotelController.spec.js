...
describe('Hotel Controller', () => {
    describe('boundary', () => {
        ...
        beforeEach(async () => {
            // Create hotel, review, and room type to use in the tests
            hotel = new Hotel({
        ...
        test(`${hotelControllerBoundaryTest} should retrieve a single hotel with its reviews`, async () => {
            const response = await request(app)
        ...
        test(`${hotelControllerBoundaryTest} should add a review to a hotel`, async () => {
            const newReview = {
                author: 'Jane Doe',
        ...
        test(`${hotelControllerBoundaryTest} should create a new room type`, async () => {
            const newRoomType = {
                type: 'Penthouse',
        ...
        test(`${hotelControllerBoundaryTest} should link a room type to a hotel`, async () => {
            const response = await request(app)
        ...
        test(`${hotelControllerBoundaryTest} should delete a hotel`, async () => {
            const response = await request(app)
        ...
        test(`${hotelControllerBoundaryTest} should delete a review for a hotel`, async () => {
            const response = await request(app)
